...
# We reject the null hypothesis of CPI at the 1% level, we find statistical evidence that 
# all the constant variables are all stationary
# We fail to reject the null hypothesis at the 1% level for M2 because we do not find
# statistical evidence that all the constant variables are not non-stationary.
# We fail to reject the null hypothesis for Population because we do not find
# statistical evidence that all the constant variables are not non-stationary.
# We fail to reject the null hypothesis for Inflation because we do not find
# statistical evidence that all the constant variables are not non-stationary.
# We fail to reject the null hypothesis for RGDPPC because we do not find
# statistical evidence that all the constant variables are not non-stationary.

### Granger Causality Test ###
GCCPII <- grangertest(RGDPPC ~ CPI, order = 2, data = Canada)
GCCPII
GCRGD <- grangertest(RGDPPC ~ M2, order = 2, data = Canada)
GCRGD
# We fail to reject the null hypothesis at the 5% level, we find statistical evidence that CPI
# does not Granger cause Other's returns at 5 lags.
# We reject the null hypothesis for M2 at the 1% level
# because we find statistically significant results
# that it Granger cause RGDPPC growth at p-value = 0.009315
